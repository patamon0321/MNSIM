...
#include"formula.h"
double accuracy, d1;
void accuracy_c(int xbarsize,int linetech,int sig_bit,int cell_bit,int resis_range,int input_err){
    ...
    //a = 0:2^sig_bit-1;
    //d1 = sum(floor(a*accuracy+0.5))/2^sig_bit/(2^sig_bit-1);  另一种精确度
