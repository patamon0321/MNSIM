...
Cal_Adder::Cal_Adder(int addinputnum, Technology tech):INV_1IN(INV,NMOS,1,3*45,3*45,3*45,45,20,tech),NAND_2IN(NAND,NMOS,2,3*45,3*45,3*45,45,20,tech),NAND_3IN(NAND,NMOS,3,3*45,3*45,3*45,45,20,tech),NAND_4IN(NAND,NMOS,4,3*45,3*45,3*45,45,20,tech){
